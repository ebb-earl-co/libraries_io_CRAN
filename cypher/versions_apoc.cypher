...
CALL apoc.periodic.iterate(
    'CALL apoc.load.csv("cran_versions.csv", {ignore:["Project_Name","Project_ID","Published_Timestamp","Created_Timestamp","Updated_Timestamp"]}) yield map return map',
    'MERGE (v:Version {number: map["Number"], ID: toInteger(map["ID"])})',
